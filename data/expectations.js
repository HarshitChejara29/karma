export const expectationsData = {
    "Expectations": [
      {
        "image": ["/activity 1.svg"],
        "title": "Essential services",
        "description": "From transportation and food to payments and shopping, your daily needs are covered."
      },
      {
        "image": ["/pie-chart 1.svg"],
        "title": "Lifestyle enhancements",
        "description": "Enjoy entertainment, health, travel, and social connections, all in one place."
      },
      {
        "image": ["/command 1.svg"],
        "title": "Personalized experiences",
        "description": "Benefit from recommendations and tailored services."
      }
    ],
    "Content": [
      {
