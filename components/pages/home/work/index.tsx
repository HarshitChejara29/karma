        ...
        <div className="container lg:px-28 px-8 lg:py-24 mt-10 mx-auto">
            <div className="flex flex-wrap -m-12">
                <div className="p-12 md:w-1/2 flex flex-col items-center lg:text-left text-center">
                    ...
                    <p className="leading-relaxed lg:mb-8 text-gray-400" data-aos="slide-up">_ Aria Zinanrio</p>
                ...
                <div className="lg:p-16 p-10 py-24 lg:w-1/2 w-full flex flex-col items-center">
                    <InquiryForm/>
                </div>
            </div>
        </div>
