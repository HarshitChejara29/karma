...
const Expectations = () => {
    ...
    return (
        ...
        <div className="container lg:px-28 px-12 lg:py-24 py-6 mx-auto">
            ...
            <div className="p-12 md:w-1/2 flex flex-col items-start lg:text-left text-center">
                <h2 className="lg:text-5xl text-3xl title-font font-medium text-white mt-4 mb-8 lg:px-0 px-5" data-aos="slide-up">What You wanna expect from us</h2>
            ...
            <div className="p-16 md:w-1/2 flex flex-col items-start hidden md:block">
