    ...
    return (
        <>
            <section className="text-white body-font bg-[#20282F] ">
                <div className="container lg:px-72 px-5 mx-auto text-center">
                    <div className="flex flex-col text-center w-full mb-7">
                        <div className="flex justify-center items-center mb-10 lg:hidden md:block">
                            <Image
                            alt="logo"
                            src="/Logo.svg"
                            width="50"
                        ...
                        <h1 className="lg:text-6xl text-3xl tracking-tighter font-medium title-font lg:mt-24 lg:mb-7 mb-3 text-white">The First True Super App</h1>
            ...
            <section className="text-gray-600 body-font bg-gradient-to-t from-[#171B23] to-[#20282F] flex justify-center items-center">
                <div className="container flex justify-center items-center lg:py-32 py-12 lg:px-0 px-5">
                    <div className="lg:w-4/5 lg:h-[650px] h-[250px] bg-[#343a41] flex rounded-3xl">
                    <div className="flex flex-col lg:gap-48 lg:ml-10 gap-24 ml-5">
                        <Image src="/images/notification.png" alt="notify" className="lg:w-[600px] w-[600px] lg:h-[130px] h-[40px] animate-bounce" width={200} height={200} />
                        <Image src="/images/chat-icon.png" alt="chat" className="lg:w-[50px] lg:h-[50px] w-[20px] h-[20px] animate-bounce z-10" width={200} height={200} />
                    </div>
                    ...
                    <div className="flex lg:gap-36 lg:mr-40 gap-14 mr-12">
                        <Image src="/images/right-icon.png" alt="right" className="lg:w-[50px] lg:h-[50px] w-[20px] h-[20px] animate-bounce" width={200} height={200} />
                        <Image src="/images/db-icon.png" alt="db" className="lg:w-[50px] lg:h-[50px] w-[20px] h-[20px] animate-bounce z-10 lg:mt-36 mt-20" width={200} height={200} />
                    </div>
                    </div>
                </div>
            </section>
